...
<section id="tabs">
                          ...
                          <table class="table table-striped">
                            ...
                            <tbody>
                                ...
                                <tr>
                                    ...
                                    <td>
                                        <form action="{{ route('fx-delete', $contact->fx_id)}}" method="post">
                                          @csrf
                                          @method('DELETE')
                                 ...
                                 <div id="editModal{{ $contact->fx_id }}" class="modal fade" role="dialog">
                                            ...
                                            <div class="modal-content">
                                                ...
                                                <form action="{{ route('fx-update', $contact->fx_id) }}" method="post">
                                                    @csrf
                                                    @method("PATCH")
                            ...
                            <tbody>
                                ...
                                <div id="editptaModal{{ $pta->pta_rate_id }}" class="modal fade" role="dialog">
                                            ...
                                            <div class="modal-content">
                                                ...
                                                <form action="{{ route('pta-update', $pta->pta_rate_id ) }}" method="post">
                                                    @method("PATCH")
                                                    @csrf
                            ...
                            <tbody>
                                ...
                                <div id="editInterestRateModal{{ $interestRate->interest_rate_id }}" class="modal fade" role="dialog">
                                            ...
                                            <div class="modal-content">
                                                ...
                                                <form action="{{ route('interestRate-update', $interestRate->interest_rate_id ) }}" method="post">
                                                    @method("PATCH")
                                                    @csrf
    ...
    <div id="myModal" class="modal fade" role="dialog">
                        ...
                        <div class="modal-content">
                            ...
                            <form action="{{ route('fx-save') }}" method="POST">
                                @csrf
                                ...
                                <div class="modal-body">
                                    <div class="form-group">
                                    <label for="fx_buy" class="col-form-label">FX Buy:</label>
                                    <input type="numeric" name="fx_buy" class="form-control" id="fx_buy" placeholder="FX Buy" required>
                                    </div>
                                </div>
                                ...
                                <div class="modal-body">
                                    <div class="form-group">
                                    <label for="fx_sell" class="col-form-label">FX Sell:</label>
                                    <input type="numeric" name="fx_sell" class="form-control" id="fx_sell" placeholder="FX Sell" required>
                                    </div>
                                </div>
    ...
    <div id="ptaModal" class="modal fade" role="dialog">
                        ...
                        <div class="modal-content">
                            ...
                            <form action="{{ route('pta-save') }}" method="post">
                                @csrf
                ...
                <option value="Zimbabwe">Zimbabwe</option>
                                ...
                                <div class="modal-body">
                                    <div class="form-group">
                                    <label for="pta_name" class="col-form-label">PTA Name:</label>
                                    <input type="text" name="pta_name" class="form-control" id="pta_name" placeholder="PTA" required>
                                    </div>
                                </div>
                                ...
                                <div class="modal-body">
                                    <div class="form-group">
                                    <label for="value" class="col-form-label">Value:</label>
                                    <input type="numeric" name="value" class="form-control" id="value" placeholder="Value" required>
                                    </div>
                                </div>
    ...
    <div id="interestRateModal" class="modal fade" role="dialog">
                        ...
                        <div class="modal-content">
                            ...
                            <form action="{{ route('interestRate-save') }}" method="post">
                                @csrf
                ...
                <option value="Zimbabwe">Zimbabwe</option>
                                ...
                                <div class="modal-body">
                                    <div class="form-group">
                                    <label for="interest_category" class="col-form-label">Interest Category:</label>
                                    <input type="text" name="interest_category" class="form-control" id="interest_category" placeholder="Interest Category" required>
                                    </div>
                                </div>
                                ...
                                <div class="modal-body">
                                    <div class="form-group">
                                    <label for="above_5m" class="col-form-label">Above 5m:</label>
                                    <input type="numeric" name="above_5m" class="form-control" id="above_5m" placeholder="Above 5m" required>
                                    </div>
                                </div>
                                ...
                                <div class="modal-body">
                                    <div class="form-group">
                                    <label for="below_5m" class="col-form-label">Below 5m:</label>
                                    <input type="numeric" name="below_5m" class="form-control" id="below_5m" placeholder="Below 5m" required>
                                    </div>
                                </div>
