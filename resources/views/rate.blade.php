	...
	<div class="container">
		...
		<div class="row">
			<div class="col-xs-12 ">
                            ...
                            <tbody>
                                ...
                                <tr>
                                 ...
                                 <div id="editModal{{ $contact->fx_id }}" class="modal fade" role="dialog">
                                        ...
                                        <option  value="{{ $contact->currency }}">{{ $contact->currency }}</option>
                                         ...
                                         <option   value="ZAR">ZAR</option>
                                                    ...
                                                    <div class="modal-body">
                                                        ...
                                                        <input type="number" name="fx_buy" class="form-control" id="fx_buy" value="{{ $contact->fx_buy }}">
                                                        </div>
                                                    </div>
                                                    ...
                                                    <div class="modal-body">
                                                        ...
                                                        <input type="number" name="fx_sell" class="form-control" id="fx_sell" value="{{ $contact->fx_sell }}">
                                                        </div>
                                                    </div>
                ...
                <option value="{{ $pta->country }}">{{ $pta->country }}</option>
                <option value="Afghanistan">Afghanistan</option>
                <option value="Åland Islands">Åland Islands</option>
                <option value="Albania">Albania</option>
                <option value="Algeria">Algeria</option>
                ...
                <option value="Zimbabwe">Zimbabwe</option>
                                                    ...
                                                    <div class="modal-body">
                                                        ...
                                                        <select name="currency" class="form-control" required>
                                        <option  value="{{ $pta->pta_name }}">{{ $pta->pta_name }}</option>
                                        <option  value="ARS">ARS</option>
                                         ...
                                         <option   value="ZAR">ZAR</option>
                                                    ...
                                                    <div class="modal-body">
                                                        ...
                                                        <input type="number" name="value" class="form-control" id="value" value="{{ $pta->value }}">
                                                        </div>
                                                    </div>
                ...
                <option value="{{ $interestRate->country }}">{{ $interestRate->country }}</option>
                <option value="Afghanistan">Afghanistan</option>
                <option value="Åland Islands">Åland Islands</option>
                <option value="Albania">Albania</option>
                <option value="Algeria">Algeria</option>
                ...
                <option value="Zimbabwe">Zimbabwe</option>
                                                    ...
                                                    <div class="modal-body">
                                                        ...
                                                        <input type="text" name="above_5m" class="form-control" id="above_5m" value="{{ $interestRate->above_5m }}">
                                                        </div>
                                                    </div>
                                                    ...
                                                    <div class="modal-body">
                                                        ...
                                                        <input type="text" name="below_5m" class="form-control" id="below_5m" value="{{ $interestRate->below_5m }}">
                                                        </div>
                                                    </div>
                        ...
                        <div class="modal-content">
                            ...
                            <form action="{{ route('fx-save') }}" method="POST">
                                ...
                                <div class="modal-body">
                                    <div class="form-group">
                                    <label for="fx_buy" class="col-form-label">FX Buy:</label>
                                    <input type="number" name="fx_buy" class="form-control" id="fx_buy" placeholder="FX Buy" required>
                                    </div>
                                </div>
                                ...
                                <div class="modal-body">
                                    <div class="form-group">
                                    <label for="fx_sell" class="col-form-label">FX Sell:</label>
                                    <input type="number" name="fx_sell" class="form-control" id="fx_sell" placeholder="FX Sell" required>
                                    </div>
                                </div>
    ...
    <div id="interestRateModal" class="modal fade" role="dialog">
                ...
                <option value="Zimbabwe">Zimbabwe</option>
                                ...
                                <div class="modal-body">
                                    <div class="form-group">
                                    <label for="above_5m" class="col-form-label">Above 5m:</label>
                                    <input type="text" name="above_5m" class="form-control" id="above_5m" placeholder="Above 5m" required>
                                    </div>
                                </div>
                                ...
                                <div class="modal-body">
                                    <div class="form-group">
                                    <label for="below_5m" class="col-form-label">Below 5m:</label>
                                    <input type="text" name="below_5m" class="form-control" id="below_5m" placeholder="Below 5m" required>
                                    </div>
                                </div>
